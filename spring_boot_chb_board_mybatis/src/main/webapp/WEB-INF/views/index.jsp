						...
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<sec:authorize access="isAuthenticated()">
									<li><a href="#"><sec:authentication property="principal.username"/>님 환영합니다.</a></li>
										...
										<div class="product-image-wrapper">
											<div class="single-products">
													<div class="productinfo text-center">
														<img src="/images/home/product${dept.deptno}.jpg"  />
														<h2>$56</h2>
														<p>${emp.job}</p>
														<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>${dept.loc}</a>
													</div>
